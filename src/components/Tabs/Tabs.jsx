    ...
    return (
        <div className='tabs-container'>
            ...
            <div className='btn-tab-grp'>
                <button className={`btn-tab ${active === 0 ? 'active' : ''}`} onClick={() => setActive(0)} >Simple Bookmarking</button>
                <button className={`btn-tab ${active === 1 ? 'active' : ''}`} onClick={() => setActive(1)} > Speedy Searching</button>
                <button className={`btn-tab ${active === 2 ? 'active' : ''}`} onClick={() => setActive(2)} >Easy Sharing</button>
            </div>
